        ...
        return (
            <div>
                ...
                <div className="container-fluid jumbotron">
                    ...
                    <p>
                        OWASP OWTF is a project that aims to make security assessments as efficient as
                        possible. Some of the ways in which this is achieved are:
                    </p>
                    <ul>
                        <li>Separating the tests that require no permission from the ones that require
                            permission (i.e. active/ bruteforce).</li>
